...
const bool:zombieclass1_infection = true;
const bool:zombieclass1_blood = true;
...
public plugin_precache()
{
	...
	g_ZombieClassID = zp_class_zombie_register(zombieclass1_name, zombieclass1_info, zombieclass1_health, zombieclass1_speed, zombieclass1_gravity, zombieclass1_infection, intervalPrimaryAttack, intervalSecondaryAttack, damagePrimaryAttack, damageSecondaryAttack, zombieclass1_blood)
