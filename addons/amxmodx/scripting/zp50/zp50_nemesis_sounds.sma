...
{
	register_plugin("[ZP] Sound: Nemesis", ZP_VERSION_STRING, "Mostten")
	...
	zp_nemesis_sound_register(ZP_INVALID_SOUND_ID, nemesis_pain, nemesis_die, nemesis_fall, nemesis_miss_slash, nemesis_miss_wall, nemesis_hit_normal, nemesis_hit_stab, nemesis_idle, nemesis_idle_last);
